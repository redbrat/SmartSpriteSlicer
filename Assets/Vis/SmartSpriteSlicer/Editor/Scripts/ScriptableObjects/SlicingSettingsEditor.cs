...
namespace Vis.SmartSpriteSlicer
{
    ...
    public class SlicingSettingsEditor : Editor
    {
        ...
        //            {
        //                if (DragableButton.Draw(new GUIContent("+", "Create new chunk"), chunkButtonStyle, false, GUILayout.Width(34f)) == DraggableButtonResult.Clicked)
        //                {
        ...
        //                var draggableButtonResult = DragableButton.Draw(new GUIContent($"{chunk._size.x}x{chunk._size.y}"), chunkButtonStyle, true, GUILayout.MinWidth(80f));
        ...
        //                        target.ChunkGroups.Add(new SpriteGroup() { ChunkId = chunk.Id });
        //                        break;
        //                    default:
        //                        break;
        //                }
